...
interface MaritalStatusSearchFilterProps {
...
export function MaritalStatusSearchFilter({
  isFilterOpen,
  setIsFilterOpen,
  filterConditions,
  setFilterConditions,
  ...
  onRefresh,
  isInline = false
}: MaritalStatusSearchFilterProps) {
  return (
            ...
            {filterConditions.map((condition, index) => (
              <div key={condition.id} className="flex items-center gap-3">
                ...
                >
                  ...
                  <option value="grantedPersonName">Họ tên người được cấp</option>
                  <option value="grantedPersonPersonalId">Số định danh</option>
                  <option value="certIssueDate">Ngày cấp</option>
