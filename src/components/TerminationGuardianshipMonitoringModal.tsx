              ...
              <div className="px-6 pt-4 flex-shrink-0 border-b border-slate-200">
                <div className="flex items-center gap-1 flex-wrap">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${
                      detailTab === 'monitor' ? 'border-red-600 text-red-600' : 'border-transparent text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    👤 Người giám sát
                  </button>
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${
                      detailTab === 'guardianship' ? 'border-red-600 text-red-600' : 'border-transparent text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    🛡️ Việc giám hộ
                  </button>
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${
                      detailTab === 'general' ? 'border-red-600 text-red-600' : 'border-transparent text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    📋 Thông tin khác
                  </button>
              ...
              <div className="p-6 flex-1 overflow-auto">
                ...
                {detailTab === 'record' && (
                  <div className="space-y-6">
                    <div className="mb-6">
                      <h4 className="text-sm font-medium text-slate-900 bg-slate-100 px-3 py-2 mb-3 border-l-4 border-orange-600">Bộ dữ liệu hồ sơ đăng ký chấm dứt giám sát việc giám hộ</h4>
                    ...
                    <div className="mb-6">
                      <h4 className="text-sm font-medium text-slate-900 bg-slate-100 px-3 py-2 mb-3 border-l-4 border-red-600">Thông tin người đăng ký chấm dứt giám sát việc giám hộ</h4>
                      <div className="grid grid-cols-2 gap-3">
                ...
                {detailTab === 'monitor' && (
                  <div className="space-y-6">
                    <div className="mb-6">
                      <h4 className="text-sm font-medium text-slate-900 bg-slate-100 px-3 py-2 mb-3 border-l-4 border-red-600">Người giám sát (cá nhân)</h4>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="border border-slate-200 p-2 rounded col-span-2">
                          <div className="text-xs text-slate-600 mb-1">Họ, chữ đệm, tên</div>
                    ...
                    <div className="mb-6">
                      <h4 className="text-sm font-medium text-slate-900 bg-slate-100 px-3 py-2 mb-3 border-l-4 border-red-600">Người giám sát (pháp nhân)</h4>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="border border-slate-200 p-2 rounded col-span-2">
                ...
                {detailTab === 'guardianship' && (
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-slate-900 bg-slate-100 px-3 py-2 mb-3 border-l-4 border-red-600">Thông tin về việc giám hộ đã được giám sát</h4>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="border border-slate-200 p-2 rounded">
                ...
                {detailTab === 'general' && (
                  <div className="space-y-6">
                    <div className="mb-6">
                      <h4 className="text-sm font-medium text-slate-900 bg-slate-100 px-3 py-2 mb-3 border-l-4 border-red-600">Thông tin chung</h4>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="border border-slate-200 p-2 rounded col-span-2">
