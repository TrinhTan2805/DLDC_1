                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                      <div className="space-y-1 col-span-full">
                        <div className="text-[11px] text-slate-500 font-medium uppercase tracking-tight">Tên điều ước / Thỏa thuận / Dự án</div>
                        <div className="text-sm text-slate-900 font-bold">{selectedRecord.name}</div>
                      </div>
                      <div className="space-y-1">
                        <div className="text-[11px] text-slate-500 font-medium uppercase tracking-tight">Đối tác / Quốc gia</div>
                        <div className="text-sm text-slate-900 font-medium">{selectedRecord.partner}</div>
                      </div>
                      <div className="space-y-1">
                        <div className="text-[11px] text-slate-500 font-medium uppercase tracking-tight">Số hiệu / Mã số</div>
                        <div className="text-sm text-slate-900 font-semibold font-mono">{selectedRecord.number}</div>
                      </div>
                      <div className="space-y-1">
                        <div className="text-[11px] text-slate-500 font-medium uppercase tracking-tight">Ngày thực hiện</div>
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-2 gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-sm text-slate-900 font-medium">CSDL Hợp tác quốc tế</div>
                      </div>
                    </div>
                  </section>
                </div>
