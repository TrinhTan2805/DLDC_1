        ...
        <div className="bg-white rounded-lg border border-gray-200">
          ...
          <div className="p-6 space-y-6">
            {notifications.map((notification) => (
              <div key={notification.id} className={`border-2 rounded-lg overflow-hidden ${notification.type === 'error' ? 'border-red-200' : 'border-green-200'
                }`}>
                {/* Header */}
                <div className={`px-6 py-4 ${notification.type === 'error' ? 'bg-red-50' : 'bg-green-50'
                  }`}>
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right">
                      <span className={`px-4 py-2 rounded-full text-base ${notification.status === 'sent'
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea aria-label="Text input"
                  ...
                  defaultValue="Kính gửi [TÊN_ĐƠN_VỊ],&#10;&#10;Hệ thống Kho DLDC đã tiếp nhận thành công [SỐ_BẢN_GHI] bản ghi từ hệ thống của quý đơn vị.&#10;Mã giao dịch: [MÃ_GIAO_DỊCH]"
                ></textarea>
              </div>
              <div>
