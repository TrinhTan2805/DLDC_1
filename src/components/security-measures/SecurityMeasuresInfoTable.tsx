...
export interface SecurityMeasuresRecord {
  id: string;
  name: string;
  gender?: string;
  birthDate?: string;
...
interface SecurityMeasuresInfoTableProps {
  records: SecurityMeasuresRecord[];
  currentPage: number;
  setCurrentPage: (page: number) => void;
  itemsPerPage: number;
  setItemsPerPage: (items: number) => void;
  totalRecords: number;
  onViewRecord: (record: SecurityMeasuresRecord) => void;
  colNameLabel?: string;
  colTypeLabel?: string;
...
export function SecurityMeasuresInfoTable({
  records,
  currentPage,
  setCurrentPage,
  itemsPerPage,
  ...
  colTypeLabel = 'Giới tính',
  colNumberLabel = 'Số đăng ký',
  colDateLabel = 'Ngày đăng ký',
}: SecurityMeasuresInfoTableProps) {
