...
interface TerminationGuardianshipSearchFilterProps {
...
export function TerminationGuardianshipSearchFilter({
  isFilterOpen,
  setIsFilterOpen,
  filterConditions,
  setFilterConditions,
  ...
  onRefresh,
  isInline = false
}: TerminationGuardianshipSearchFilterProps) {
  return (
            ...
            {filterConditions.map((condition, index) => (
              <div key={condition.id} className="flex items-center gap-3">
                ...
                >
                  ...
                  <option value="wardName">Người được giám hộ</option>
                  <option value="recordCode">Mã hồ sơ</option>
                  <option value="terminationReason">Lý do chấm dứt</option>
                </select>
