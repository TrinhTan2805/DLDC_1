...
interface MeritoriousSearchFilterProps {
...
export function MeritoriousSearchFilter({
  isFilterOpen,
  setIsFilterOpen,
  filterConditions,
  setFilterConditions,
            ...
            {filterConditions.map((condition, index) => (
              <div key={condition.id} className="flex items-center gap-3">
                ...
                >
                  ...
                  <option value="idCard">Số định danh / CMND</option>
                  <option value="recordNumber">Số hiệu hồ sơ</option>
