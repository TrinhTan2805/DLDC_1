...
import { SocialSecuritySearchFilter } from './SocialSecuritySearchFilter';
import { SocialSecurityTable } from './SocialSecurityTable';
...
export function SocialSecurityModal({ 
  isOpen, 
  onClose, 
  title,
  isInline = false
}: SocialSecurityModalProps) {
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                      ...
                      <div className="space-y-1 col-span-full">
                        <div className="text-[11px] text-slate-500 font-medium uppercase tracking-tight">Địa bàn cư trú</div>
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-2 gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-sm text-slate-900 font-medium">CSDL BHXH và Giảm nghèo</div>
                      </div>
                    </div>
                  </section>
                </div>
