...
export function ViewCollectedDataPage({ onNavigate }: { onNavigate?: (id: string) => void }) {
  ...
  const internalDatabases = [
    ...
    { id: "data-info-civil-legal-info", title: "HTTT TTTG pháp lý dân sự (6)", count: 1100000, status: 'active' as const },
    { id: "data-info-legal-center", title: "HTTT TG Pháp lý", count: 920000, status: 'active' as const },
