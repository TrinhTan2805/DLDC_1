  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 py-4 space-y-6">
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="ml-[152px] text-[13px] text-slate-500 italic">
        ...
        <div className="flex-1 max-w-2xl flex flex-col gap-3">
          <div className="flex items-center gap-3">
            <input 
              ...
              className="w-24 px-4 py-2 text-[13px] border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white shadow-sm"
            />
      ...
      <div className="flex items-start gap-6">
        ...
        <textarea 
          ...
          rows={3}
          className="flex-1 max-w-2xl px-4 py-3 text-[13px] border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white resize-y shadow-sm"
        />
      </div>
