...
export function ChildrenGroupPage({ mode = 'thu thập', context = 'thu thập' }: ChildrenGroupPageProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Stats Grid - 1 card in 4 columns */}
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-6">
        ...
        <div className="relative h-96 pl-16 pr-4 pt-8 pb-20">
          ...
          {/* Bars - Stacked */}
          <div className="absolute left-16 right-4 top-8 bottom-20 flex items-end justify-center gap-1">
            {chartData.map((data, index) => {
              ...
              return (
                <div key={index} className="w-20 flex flex-col items-center relative" style={{ height: '100%' }}>
