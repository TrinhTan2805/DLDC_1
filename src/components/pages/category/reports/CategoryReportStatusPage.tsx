      ...
      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 shadow-sm relative z-30">
        <div className="flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
          <div className="flex-1 w-full grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Trạng thái danh mục</label>
              <div className="relative" ref={statusRef}>
                <button
                  ...
                  className={`w-full px-4 py-2.5 border rounded-xl text-sm bg-white text-left flex items-center justify-between gap-2 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500/20 ${
                    showStatusDropdown ? 'border-blue-400 ring-2 ring-blue-500/20' : 'border-slate-300 hover:border-slate-400'
                  }`}
                >
            ...
            {/* Thời gian */}
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-2">Thời gian chuyển trạng thái</label>
              <select
                title="Thời gian"
                value={dateRange}
