                        ...
                        {isEditingTable ? (
                          ...
                          <>
                            <button 
                              ...
                              className="px-3 py-1.5 bg-blue-50 text-blue-600 rounded text-sm font-medium hover:bg-blue-100 flex items-center gap-1.5"
                            >
                              Chỉnh sửa cấu trúc
                            </button>
                            <button 
                            ...
                            <button 
                              ...
                              className="px-3 py-1.5 bg-red-50 text-red-600 rounded text-sm font-medium hover:bg-red-100 flex items-center gap-1.5"
                            >
                              Xóa bảng
                            </button>
                          </>
