...
export function TargetDatabaseConfigModal({
  ...
  const footer = (
    <div className="flex items-center justify-between w-full">
      <button
        onClick={onBack}
        className="flex items-center gap-2 px-6 py-2.5 text-sm font-medium text-slate-600 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-all shadow-sm active:scale-95"
      >
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="flex items-center gap-2 px-6 py-2.5 text-sm font-medium text-blue-600 bg-blue-50 border border-blue-200 rounded-xl hover:bg-blue-100 transition-all active:scale-95"
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-8 py-2.5 text-sm font-medium text-white rounded-xl transition-all shadow-md ${isNextDisabled
