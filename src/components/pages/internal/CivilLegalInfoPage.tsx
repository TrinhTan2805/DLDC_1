...
export function CivilLegalInfoPage({ mode = 'thu thập', context = 'thu thập' }: CivilLegalInfoPageProps) {
  ...
  const tableData: DatabaseRecord[] = [
    ...
    { name: 'Dữ liệu Thông tin văn bản cử người thực hiện trợ giúp pháp lý', category: 'HT TTTG pháp lý dân sự', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Trung tâm TGPL nhà nước', category: 'HT TTTG pháp lý dân sự', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Chi nhánh TGPL', category: 'HT TTTG pháp lý dân sự', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Người thực hiện TGPL', category: 'HT TTTG pháp lý dân sự', todayCount: 20000, errorCount: 30 },
  ];

  // Chart data matching stats totals
  const chartData = stats.map((stat, index) => {
    const names = ['TC thực hiện', 'TC đăng ký', 'VB cử người', 'TT TGPL NN', 'Chi nhánh', 'Người thực hiện'];
    return {
      name: names[index],
