...
export function FamilyBasePage({ mode = 'thu thập', context = 'thu thập' }: FamilyBasePageProps) {
  ...
  const tableData: DatabaseRecord[] = [
    ...
    { name: 'D liệu Chương trình, kế hoạch về phổ biến, giáo dục pháp luật', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Hội đồng phối hợp phổ biến, giáo dục pháp luật', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Đề án', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Hội nghị tập huấn (trực tuyến, trực tiếp)', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Hội thảo', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Tổ hoà giải', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Hoà giải viên', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Vụ việc hoà giải', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Tập huấn viên', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Kinh phí phổ biến giáo dục pháp luật', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Tiêu chí, chỉ tiêu tiếp cận pháp luật', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Đánh giá cấp xã đạt chuẩn tiếp cận pháp luật', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Cuộc PBGDPL', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
    { name: 'Dữ liệu Cuộc thi tìm hiểu về pháp luật', category: 'CSDL PB, GĐ và HG cơ sở', todayCount: 20000, errorCount: 30 },
  ];

  // Chart data matching stats totals
  const chartData = stats.map((stat, index) => {
    const names = ['Báo cáo viên', 'Tuyên truyền viên', 'Chương trình KH', 'Hội đồng', 'Đề án', 'Hội nghị TH', 'Hội thảo', 'Tổ HG', 'HG viên', 'Vụ việc HG', 'Tập huấn viên', 'Kinh phí', 'Tiêu chí', 'Đánh giá xã', 'Cuộc PBGDPL', 'Cuộc thi'];
    return {
      name: names[index],
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Stats Grid - 16 cards in 4 columns */}
              ...
              return (
                <div key={index} className="flex-1 flex flex-col items-center relative" style={{ height: '100%' }}>
                  <div className="w-full flex flex-col items-center justify-end" style={{ height: '100%' }}>
                    ...
                    <div className="w-full max-w-[25px] flex flex-col relative" style={{ height: `${totalPercent}%`, minHeight: '8px' }}>
