...
interface NationalityInfoSearchFilterProps {
...
export function NationalityInfoSearchFilter({
  isFilterOpen,
  setIsFilterOpen,
  filterConditions,
  setFilterConditions,
  onRefresh,
  isInline = false
}: NationalityInfoSearchFilterProps) {
  return (
            ...
            {filterConditions.map((condition, index) => (
              <div key={condition.id} className="flex items-center gap-3">
                ...
                >
                  ...
                  <option value="decisionNo">Số quyết định</option>
                  <option value="date">Ngày cấp</option>
